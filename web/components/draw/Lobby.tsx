...
interface LobbyProps {
  ...
  onCreate: (config: DrawRoomConfig, name: string) => void;
      ...
      <div className="flex flex-1 items-center justify-center bg-linear-to-br from-[var(--primary)] via-[var(--primary-dark)] to-[#1a0f38] p-6">
        <div className="w-full max-w-lg">
          <div className="mb-8 text-center">
            ...
            <h2 className="mb-2 text-3xl font-extrabold tracking-tight text-white">DrawIt</h2>
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            >
              ...
              <span className="text-sm font-medium text-white/60">Configure a partida e convide amigos</span>
            </button>
